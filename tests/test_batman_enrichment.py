...
from tcr_explorer.models import GeneRecord, SearchRequest
...
class TestEnrichWithBatman:
    ...
    @patch("tcr_explorer.api.batman_client")
    def test_enrichment_attaches_scores_to_records(self, mock_client):
        ...
        from tcr_explorer.api import _enrich_with_batman
    ...
    def test_composite_score_computed_from_available_scores(self, mock_client):
        ...
        from tcr_explorer.api import _enrich_with_batman, _composite_score

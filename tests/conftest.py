"""conftest.py — install lightweight stubs for optional imgt_app dependencies.
...
_stub_if_missing("imgt_app.cdr_enricher", get_cdr1_cdr2=lambda v_gene, species="human": {
    "allele": None, "cdr1_aa": None, "cdr2_aa": None,
    "cdr1_nt": None, "cdr2_nt": None,
})

_stub_if_missing("imgt_app.fasta_parser",
...
_stub_if_missing("imgt_app.nl_query",
      lmstudio_parse=_fake_lmstudio_parse,
      heuristic_parse=_fake_heuristic_parse)

_stub_if_missing("imgt_app.reconstructor", reconstruct_tcr=lambda *a, **kw: {
...
_stub("imgt_app.mcp_clients", ToolServerClient=_FakeToolServerClient)
...
_stub_if_missing("imgt_app.search_index", SearchIndex=_FakeSearchIndex)

_stub_if_missing("imgt_app.file_ingest",
